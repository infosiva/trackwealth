    ...
    <>
      <button
        ...
        style={{ position: 'fixed', bottom: 24, right: 24, width: 52, height: 52, borderRadius: '50%',
          ...
          boxShadow: '0 4px 20px rgba(5,150,105,0.35)', zIndex: 1000, fontSize: 20,
      ...
      <div
        style={{ position: 'fixed', bottom: 88, right: 24, width: 320, height: 420,
          ...
          overflow: 'hidden', boxShadow: '0 8px 40px rgba(5,150,105,0.15)',
      ...
      >
        ...
        <div style={{ padding: '10px 12px', borderTop: '1px solid #f1f5f9', display: 'flex', gap: 8 }}>
          ...
          <button onClick={send} disabled={loading}
            style={{ background: '#059669', border: 'none', borderRadius: 8, padding: '7px 13px', fontSize: 13, color: '#fff', cursor: 'pointer', fontWeight: 700 }}>→</button>
        </div>
      </div>
    </>
  )
